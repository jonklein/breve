...
class Mobile( breve.Real ):
	...
	def getDistance( self, otherObject ):
		...
		return len( ( self.getLocation() - otherObject.getLocation() ) )
	...
	def point( self, theVertex, theLocation ):
		...
		if ( breve.length( v ) == 0.000000 ):
			self.setRotationAboutAxis( theVertex, 0.010000 )
			return


		self.setRotationAboutAxis( v, a )
	...
	def rotate( self, thisAxis, amount ):
		...
		self.setRotationAboutAxis( thisAxis, amount )
	...
	def setRotationEulerAngles( self, angles ):
		...
		m = matrix(  r00, r01, r02, r10, r11, r12, r20, r21, r22 )
		self.setRotation( m )
