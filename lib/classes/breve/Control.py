...
class Control( breve.Abstract ):
	...
	def acceptUpload( self, uploadedObject, host ):
		...
		print '''object  sent from host ''' % (  uploadedObject, host )
	...
	def addMenu( self, menuName, theMethod ):
		...
		return breve.MenuItem().createMenu( menuName, self, theMethod )


	def addMenuSeparator( self ):
		'''Adds a separator menu item--really just an empty menu item.'''

		return breve.MenuItem().createMenu( '''''', self, '''''' )
	...
	def disableShadowVolumes( self ):
		...
		self.shadowVolumeFlag = 0
		breve.breveInternalFunctionFinder.setDrawShadowVolumes( self, self.shadowFlag )
	...
	def init( self ):
		...
		self.setBackgroundColor( breve.vector( 0.500000, 0.500000, 1.000000 ) )
		...
		self.addMenuSeparator()
		self.genericShape = breve.Sphere().initWith( 1.000000 )
		self.genericLinkShape = breve.Cube().initWith( breve.vector( 0.100000, 0.100000, 0.100000 ) )
	...
	def moveLight( self, theLocation ):
		...
		breve.breveInternalFunctionFinder.setLightPosition( self, theLocation )
	...
	def pointCamera( self, location, offset ):
	...
	def setBackgroundTexture( self, newTexture ):
		...
		breve.breveInternalFunctionFinder.setBackgroundTexture( self, ( newTexture + 1 ) )
	...
	def setBackgroundTextureImage( self, newTextureImage ):
		...
		breve.breveInternalFunctionFinder.setBackgroundTexture( self, self.backgroundTexture )
	...
	def setDisplayMessage( self, theString, messageNumber, xLoc, yLoc, textColor ):
	...
	def setDisplayText( self, messageNumber, theString, xLoc, yLoc ):
		...
		breve.breveInternalFunctionFinder.cameraSetText( self, theString, messageNumber, xLoc, yLoc, breve.vector( 0, 0, 0 ) )
	...
	def setLightAmbientColor( self, newColor ):
		...
		breve.breveInternalFunctionFinder.setLightAmbientColor( self, newColor )

	def setLightColor( self, newColor ):
	...
	def setLightDiffuseColor( self, newColor ):
		...
		breve.breveInternalFunctionFinder.setLightDiffuseColor( self, newColor )
	...
	def setRandomSeedFromDevRandom( self ):
		...
		breve.breveInternalFunctionFinder.randomSeedFromDevRandom( self)
