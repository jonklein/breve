...
class Control( breve.Abstract ):
	...
	slots = [ 'backgroundColor', 'backgroundTexture', 'blurFactor', 'blurFlag', 'blurMenu', 'camOffset', 'camTarget', 'camera', 'cameraPointer', 'deltaOffset', 'deltaTarget', 'drawEveryFrame', 'drawMenu', 'floorDefined', 'fogColor', 'fogFlag', 'fogIntensity', 'fogMenu', 'frozen', 'genericLinkShape', 'genericShape', 'lightAmbientColor', 'lightDiffuseColor', 'lightFlag', 'lightMenu', 'lightPosition', 'loadedImages', 'movie', 'movieMenu', 'offsetting', 'reflectFlag', 'reflectMenu', 'selectedObject', 'shadowFlag', 'shadowMenu', 'shadowVolumeFlag', 'simStep', 'simTime', 'smoothFlag', 'watchObject', 'xRot', 'yRot', ]
