...
class PrismaticJoint( breve.Joint ):
	...
	def link( self, parentLink, childLink, theNormal, parentPoint, childPoint, currentRotation = 0.000000 ):
...
class FixedJoint( breve.Joint ):
	...
	def link( self, parentLink, childLink, parentPoint = breve.vector( 0.000000, 0.000000, 0.000000 ), childPoint = breve.vector( 0.000000, 0.000000, 0.000000 ), currentRotation = 0.000000 ):
...
class UniversalJoint( breve.Joint ):
	...
	def link( self, parentLink, childLink, normal, parentPoint, childPoint, currentRotation = 0.000000 ):
...
class BallJoint( breve.Joint ):
	...
	def link( self, parentLink, childLink, parentPoint, childPoint, normal = breve.vector( 1.000000, 0.000000, 0.000000 ), currentRotation = 0.000000 ):
