...
class Object( object ):
	...
	def archiveAsXml( self, fileName ):
		...
		breve.breveInternalFunctionFinder.brIXMLArchiveObjectToFile( self, self, fileName )

	def archiveAsXmlString( self ):
		'''XML encodes this object, and returns the encoded string.'''

		return breve.breveInternalFunctionFinder.brIXMLArchiveObjectToString( self, self )
