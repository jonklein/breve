...
class Terrain( breve.Real ):
	...
	def generate( self, ruggedness, terrainHeight ):
		''''''

		self.generateFractalTerrain( ruggedness, terrainHeight )

	def generateFractalTerrain( self, ruggedness, terrainHeight ):
	...
	def init( self ):
		...
		self.setValleyColor( breve.vector( 0, 0, 0.100000 ) )
		self.setTextureImage( breve.Image().load( '''images/grass.jpg''' ) )
