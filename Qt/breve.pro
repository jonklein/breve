...
LIBS    += -L../lib -lbreve  -lode -lgsl -lgsl -lpng -lavformat -lavcodec -lavutil -lgslcblas -lreadline -lhistory -lncurses -lsndfile -ltiff -ljpeg -lexpat -lz -pthread -lm  -lglut -lGLU -lGL -lXmu -lXi  -lX11  -lSM -lICE 
