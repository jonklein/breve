...
BEGIN_EVENT_TABLE( FindDialog, wxDialog )
    EVT_TEXT_ENTER( ID_FIND_FINDCTRL, FindDialog::OnFindSearchCtrlEnter )
    ...
    EVT_BUTTON( ID_FIND_REPLACE, FindDialog::OnFindReplaceClick )
    EVT_BUTTON( ID_FIND_REPLACE_ALL, FindDialog::OnFindReplaceAllClick )
...
void FindDialog::CreateControls() {    
	...
	if( mode == 0 ) {
    	ButtonSearch = new wxButton( itemDialog1, ID_FIND_SEARCH, _("Search"), wxDefaultPosition, wxDefaultSize, 0 );
    	itemBoxSizer11->Add( ButtonSearch, 0, wxALIGN_CENTER_HORIZONTAL|wxALL, 5 );
	} else {
    	ButtonNext = new wxButton( itemDialog1, ID_FIND_SEARCH, _("Find Next"), wxDefaultPosition, wxDefaultSize, 0 );
    	itemBoxSizer11->Add( ButtonNext, 0, wxALIGN_CENTER_HORIZONTAL|wxALL, 5 );

    	ButtonSearch = new wxButton( itemDialog1, ID_FIND_REPLACE, _("Replace"), wxDefaultPosition, wxDefaultSize, 0 );
    	itemBoxSizer11->Add( ButtonSearch, 0, wxALIGN_CENTER_HORIZONTAL|wxALL, 5 );

    	ButtonSearch = new wxButton( itemDialog1, ID_FIND_REPLACE_ALL, _("Replace All"), wxDefaultPosition, wxDefaultSize, 0 );
    	itemBoxSizer11->Add( ButtonSearch, 0, wxALIGN_CENTER_HORIZONTAL|wxALL, 5 );
	}
...
bool FindDialog::DoFind( bool doReplace, bool fromTop ) {
    int i = 0, n = 0;
