...
class Creature( breve.MultiBody ):
	...
	def init( self ):
		...
		self.addDependency( self.joints[ 0 ] )
		self.addDependency( self.joints[ 1 ] )
		self.addDependency( self.joints[ 2 ] )
		self.addDependency( self.joints[ 3 ] )
		self.addDependency( self.joints[ 4 ] )
		self.addDependency( self.joints[ 5 ] )
		self.addDependency( self.joints[ 6 ] )
		self.addDependency( self.joints[ 7 ] )
